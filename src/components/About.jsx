            ...
            <React.Fragment>
                <Container className="mt-1">
                    <Jumbotron>
                        ...
                        {/*Image className="mb-4" src={AboutPic} fluid />*/}
                        <Row className="mx-lg-3 mt-3">
                            ...
                            <Col md={0}></Col>
                            <Col className="" md={6}><p>After the summer tour he took a break from playing live shows and started to work hard with songwriting and production. With all of his influences from Rock, Soul, Funk, Classical Guitar Jonas Snitt found his own Pop sound in the way he sings, writes and produces songs. 
                                This resulted to the new EP album with six Acoustic / Pop songs.

                                The singel ”When I Wake Up” was mastered by Randy Merrill at Sterling Sound NY (Adele, John Mayer, Taylor Swift...)  where Jonas received an email from Randy saying: ” Thank you for sending me this fantastic song to master today ”. 

                                Jonas Snitt musical journey will never stop, stay tuned!
</p>
                            </Col>
                        </Row>
                    </Jumbotron>
