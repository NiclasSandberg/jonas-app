...
const MusicVideos = () => {
    ...
    return (
        ...
        <Row>
          ...
          <Col xs={7} md={7}>
          <Image src={RedJacketSmall} srcSet={`${RedJacketSmall} 300w, ${RedJacketSmall} 768w, ${RedJacketLarge} 1280w`} thumbnail/>
           {/*<Image src={RödJacka}
      ...
      <Col sm={4}>
      <ReactPlayer width="auto" controls={true} className="mt-2"
        url="https://www.youtube.com/watch?v=uqh3dbXCcuU"
      />
      </Col>
       <Col sm={4}>
      <ReactPlayer width="auto" controls={true} className="mt-2"
        url="https://www.youtube.com/watch?v=eo5IiNrjLn0"
      />
      </Col>
      </Row>
      </Container>
